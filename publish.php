...
{   
    ...
    $pic = imgUpload($_FILES['file']); //  $_FILES['file' 获取表单传过来的文件
    ...
    // 入库处理
    $sql = "INSERT `im_goods`(`name`,`price`,`des`,`content`,`pic`,`user_id`,`created_time`,`update_time`,`view`) 
    ...
    <div class="addwrap">
        <div class="addl fl">
            ...
            <form name="publish-form" id="publish-form" action="publish.php" method="post"
                  ...
                  <!-- enctype="multipart/form-data" 声明表里面有上传文件的存在 -->
                <div class="additem">
